...
#$result = invoke-command -computer "S70ADP01.STARLUMBER.COM" -scriptblock {Get-RDUserSession -ConnectionBroker "S99RDCBP01.Starlumber.com" | Select-Object -Property Username,HostServer,UnifiedSessionID} -Credential $credentials
$result = Get-RDUserSession -ConnectionBroker "S99RDCBP01.Starlumber.com" -CollectionName RFMS | Select-Object -Property CollectionName,Username,HostServer,UnifiedSessionID
#$Users = $result | Select-Object -Property Username,CollectionName
