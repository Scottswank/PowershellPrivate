...
#
#
$username = "starlumber\staradmin"
$password = ""
$credentialFilePath = "\\s99mgmntp01\PDQDeployPackages\Scripts\Dependancy\key1.Key"
$AESKeyFilePath = "\\s99mgmntp01\PDQDeployPackages\Scripts\Dependancy\key2.key"
